...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="app/bower_components/angular-ui/build/angular-ui.css">
		<link rel="stylesheet" href="app/bower_components/bookblock/css/bookblock.css">
		<link href='http://fonts.googleapis.com/css?family=Lobster' rel='stylesheet' type='text/css'>
		<script src="app/bower_components/bookblock/js/modernizr.custom.js"></script>
		<!-- endbuild -->
	</head>
	<body ng-app="publicApp">
		...
		<script src="app/bower_components/bookblock/js/jquerypp.custom.js"></script>
		<script src="app/bower_components/bookblock/js/jquery.bookblock.js"></script>
    ...
    <script src="app/bower_components/angular-mocks/angular-mocks.js"></script>
    ...
    <script src="app/bower_components/underscore/underscore.js"></script>
		...
		<!-- endbuild -->
				...
				<script src="app/scripts/directives/flipper.js"></script>
				<script src="app/scripts/controllers/newbook.js"></script>
				<script src="app/scripts/controllers/tablecontent.js"></script>
				<script src="app/scripts/services/books.js"></script>
				<script src="app/scripts/services/tablecontents.js"></script>
